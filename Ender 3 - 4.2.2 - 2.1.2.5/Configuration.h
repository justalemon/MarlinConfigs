...
#define STRING_CONFIG_H_AUTHOR "(Lemon, Dust, valerionew, Ender-3)" // Who made the changes.
...
// TODO: Test other filaments like ASA/GTP/PC that I can see in other presets
